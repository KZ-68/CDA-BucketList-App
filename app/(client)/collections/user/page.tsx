  ...
  return (
    <>
      ...
      <div className='flex items-center justify-end gap-3'>
        ...
        <Link href="/collections/new" className='flex items-center gap-3 group transition-all'>
        <p className='text-lg opacity-70 group-hover:text-neutralWhite group-hover:opacity-100'>Create a new collection</p>
          <div className='text-2xl bg-accentColor text-darkGrey p-3  flex justify-center items-center rounded-[50%] group-hover:bg-thirdColor cursor-pointer  group-hover:scale-105'>
              <LuPlus />  
          </div>
        </Link>
      </div>
